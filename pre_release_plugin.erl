...
%% TODO: consider moving prepare_release into the libconf project
...
clean(Config, _) ->
    %% NB: *this* function is one of a few that needs a custom rebar binary,
    %%      which is built using the ./configure script generated by libconf
...
fix_ejd_appfile() ->
    ...
    %% TODO: Do NOT dump out all the fields, as some of them seem to make
    %%       the reltool (or appliation loader) spew, presumably meaning they're 
